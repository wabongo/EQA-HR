          ...
          <div class="form-row">
            ...
            <div class="form-column">
              ...
              <div class="form-control-group">
                ...
                <nb-select fullWidth placeholder="Select LLC" formControlName="llcName">
                  <nb-option *ngFor="let llc of llcs" [value]="llc.name">{{ llc.name }}</nb-option>
                </nb-select>
              </div>
...
export class CreateFacilityDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: NbDialogRef<CreateFacilityDialogComponent>,
  ...
  loadLlcs() {
    this.companyService.getCompanies().subscribe( // Use getCompanies() method
      (companies) => {
        this.llcs = companies;
  ...
  submit() {
    if (this.facilityForm.valid) {
      ...
      this.dialogRef.close(newFacility);
    }
  }
